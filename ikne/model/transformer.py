...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory, input_ranges, coords_float, mask_feats_batched, lengths,
        ...
        for layer_id, layer in enumerate(self.layers):
            ...
            attn_masks = attn_masks.unsqueeze(1).expand(-1, self.nhead, -1, -1).contiguous().flatten(0,1) # for multi-head attn
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory, query_coords_float, key_coords_float,
        ...
        # key_coords_float: [max_length, B, 3]  max_length = num superpoints
